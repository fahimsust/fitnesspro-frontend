...
import { computed, type InputHTMLAttributes, useAttrs, inject, watch, ref, type Ref } from "vue";
...
<template>
  <input :class="computedClass" ref="inputRef" :type="props.type" :min="props.min" v-bind="{ ...attrs, class: undefined }"
    v-model="localValue" />
</template>
