...
let formEdit = reactive({
  required_code: condition.value.required_code,
});
...
<template>
      <div  class="col-span-12 intro-y md:col-span-3">
        <InputField :change="()=>updated=true" :blur="validateAndUpdate" :submitFunction="validateAndUpdate" name="required_code" v-model="formEdit" :error="errors.required_code"
          title="Days"  />
      </div>
</template>