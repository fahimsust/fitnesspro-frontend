...
import MainColorSwitcher from "../../components/enigma/MainColorSwitcher";
import MobileMenu from "../../components/enigma/MobileMenu";
import { useSideMenuStore } from "../../store/enigma/menus/side-menu";
import { type FormattedMenu, nestedMenu, enter, leave } from "./side-menu";
