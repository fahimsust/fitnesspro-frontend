...
import AddEditElement from "~~/components/element/AddEditElement.vue";
import UpdateTranslatedElement from "~~/components/element/UpdateTranslatedElement.vue";
...
useHead({
  title: "Edit Element: " + useRuntimeConfig().public.company,
});
...
onMounted(async () => {
  await nextTick();
  element = await getElement(idParem);
...
<template>
  <div class="mt-8">
    <div class="col-span-12 lg:col-span-12">
      <h2 class="mt-2 mr-auto text-lg font-medium intro-y">Edit Element</h2>
    </div>
    <div class="col-span-12 lg:col-span-12">
      <!-- BEGIN: Post Content -->
        ...
        <Disclosure.Group variant="boxed" v-if="dataLoaded">
          <Disclosure key="1">
            ...
            <Disclosure.Panel class="leading-relaxed text-slate-600 dark:text-slate-500">
              <AddEditElement v-model="element" />
            </Disclosure.Panel>
          </Disclosure>
